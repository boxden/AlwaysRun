...
return {
    en = {
        ...
        always_run_description = "When enabled, your character will always run unless you hold ALT or your current +speed (walk) bind.",
    ...
    fr = {
        ...
        always_run_description = "Lorsque cette option est activée, votre personnage court en permanence sauf si vous maintenez ALT ou votre touche actuelle de marche (+speed).",
    ...
    de = {
        ...
        always_run_description = "Wenn dies aktiviert ist, rennt dein Charakter immer, außer wenn du ALT oder deine aktuelle Gehen-Taste (+speed) gedrückt hältst.",
    ...
    ru = {
        ...
        always_run_description = "Когда включено, ваш персонаж всегда будет бежать, если вы не удерживаете ALT или текущую клавишу +speed (ходьбы).",
    ...
    es = {
        ...
        always_run_description = "Cuando está activado, tu personaje correrá siempre salvo que mantengas ALT o tu tecla actual de caminar (+speed).",
    ...
    zh_CN = {
        ...
        always_run_description = "启用后，除非您按住 ALT 或当前的步行键（+speed），否则角色会一直奔跑。",
    ...
    zh_TW = {
        ...
        always_run_description = "啟用後，除非您按住 ALT 或目前的步行鍵（+speed），否則角色會持續奔跑。",
    ...
    ko = {
        ...
        always_run_description = "활성화되면 ALT 또는 현재 걷기 키(+speed)를 누르고 있을 때를 제외하고 캐릭터가 항상 달립니다.",
    ...
    ja = {
        ...
        always_run_description = "有効にすると、ALT または現在の歩行キー（+speed）を押しているときを除き、キャラクターは常に走ります。",
    ...
    pl = {
        ...
        always_run_description = "Po włączeniu twoja postać będzie stale biegać, chyba że przytrzymasz ALT lub aktualny klawisz chodzenia (+speed).",
    ...
    pt = {
        ...
        always_run_description = "Quando ativado, seu personagem correrá sempre, a menos que você segure ALT ou sua tecla atual de caminhada (+speed).",
    ...
    tr = {
        ...
        always_run_description = "Etkinleştirildiğinde, ALT veya mevcut yürüme tuşunu (+speed) basılı tutmadığınız sürece karakteriniz sürekli koşar.",
    ...
    da = {
        ...
        always_run_description = "Når dette er aktiveret, løber din figur altid, medmindre du holder ALT eller din nuværende gå-tast (+speed) nede.",
    ...
    nl = {
        ...
        always_run_description = "Wanneer ingeschakeld rent je personage altijd, tenzij je ALT of je huidige looptoets (+speed) ingedrukt houdt.",
    ...
    no = {
        ...
        always_run_description = "Når dette er aktivert, vil figuren din alltid løpe med mindre du holder ALT eller din nåværende gå-tast (+speed) inne.",
        ...
        always_run_description = "Kun tämä on käytössä, hahmosi juoksee aina, ellet pidä ALT- tai nykyistä kävelynäppäintä (+speed) painettuna.",
    ...
    sv = {
        ...
        always_run_description = "När detta är aktiverat kommer din karaktär alltid att springa om du inte håller ALT eller din nuvarande gångtangent (+speed) nedtryckt.",
    ...
    cs = {
        ...
        always_run_description = "Když je tato možnost povolena, vaše postava bude vždy běžet, pokud nedržíte ALT nebo aktuální klávesu chůze (+speed).",
    ...
    hu = {
        ...
        always_run_description = "Ha ez engedélyezve van, a karaktered mindig futni fog, hacsak nem tartod lenyomva az ALT gombot vagy a jelenlegi sétáló billentyűt (+speed).",
    ...
    it = {
        ...
        always_run_description = "Quando è attivato, il tuo personaggio correrà sempre a meno che tu non tenga premuto ALT o il tuo attuale tasto per camminare (+speed).",
    ...
    uk = {
        ...
        always_run_description = "Коли ввімкнено, ваш персонаж завжди бігтиме, якщо ви не утримуєте ALT або поточну клавішу ходьби (+speed).",
    ...
    th = {
        ...
        always_run_description = "เมื่อเปิดใช้งาน ตัวละครของคุณจะวิ่งตลอดเวลา ยกเว้นเมื่อกด ALT หรือปุ่มเดินปัจจุบัน (+speed) ค้างไว้",
